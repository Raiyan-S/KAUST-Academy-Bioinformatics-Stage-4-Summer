...
seurat_object <- FindClusters(seurat_object,
                              resolution = 0.8, 
                              algorithm = 4, # default is 1 (louvain)
...
#### Exercise: test different parameter combinations #### SKIP
