...
setwd("~/Course_Materials/Week4_Metagenomics/course_metagenomics")
...
plotQualityProfile(fnFs[1:3]) + geom_vline(xintercept = 220)
...
filtFs <- file.path(
  "~/Course_Materials/Week4_Metagenomics/",
  "filtered",
...
# alpha div
alpha_div <- microbiome::alpha(ps, index = c("Chao1", "Shannon")) # Chao1 richness, Shannon diversity
